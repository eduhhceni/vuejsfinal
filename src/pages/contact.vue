<template>
  ...
  <div class="site-section">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="h3 mb-3 text-black">Contate-nos</h2>
        </div>
        <div class="col-md-7">
        ...
        <div class="col-md-5 ml-auto">
          <div class="p-4 border mb-3">
            <span class="d-block text-primary h6 text-uppercase">Nova York</span>
            <p class="mb-0">203 Fake St. Mountain View, São Francisco, California, USA</p>
          </div>
          <div class="p-4 border mb-3">
          ...
          <div class="p-4 border mb-3">
            <span class="d-block text-primary h6 text-uppercase">Canadá</span>
            <p class="mb-0">203 Fake St. Mountain View, São Francisco, California, USA</p>
          </div>
        </div>
      </div>
